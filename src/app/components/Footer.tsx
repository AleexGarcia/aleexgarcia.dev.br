...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#110D0A] text-[#F3F4F6] pt-16 pb-8 px-4 sm:p-6 md:p-8 font-sans border-t border-amber-950/40">
      <div className="max-w-6xl w-full mx-auto space-y-12">
        ...
        <div className="bg-black/30 rounded-3xl border border-amber-950/60 p-8 md:p-12 text-center space-y-6 relative overflow-hidden group hover:border-amber-500/20 transition-all duration-300 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-2">
            <a 
              href="https://wa.me/5500000000000" // Substitua pelo seu número real do WhatsApp
              target="_blank" 
              rel="noreferrer" 
              className="w-full sm:w-auto flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm px-6 py-3.5 rounded-xl transition-colors duration-200 shadow-lg shadow-emerald-950/20"
            >
              <FaWhatsapp className="text-lg" /> Iniciar Conversa no WhatsApp
            </a>
            
            <a 
              href="mailto:alexandre@exemplo.com" // Substitua pelo seu e-mail profissional
